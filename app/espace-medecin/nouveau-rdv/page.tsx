...
/*
 * « + Nouveau rendez-vous » — réservation déléguée (spec C.2.3) : le médecin
 * réserve AU NOM d'un patient, existant ou nouveau (fiche minimale sans
 * compte). Le rendez-vous est tracé « Réservé par : le cabinet · canal
 * téléphone » et occupe immédiatement le créneau partout (agenda,
 * disponibilités, côté patient).
 */
...
export default function NouveauRendezVous() {
  ...
  const fichePrete = fiche.nom.trim() !== "" && fiche.prenom.trim() !== "" && fiche.telephone.trim() !== "";
      ...
      <div className="mx-auto max-w-[780px]">
        ...
        <div className="mb-[18px] rounded-[18px] border border-line bg-white p-6">
          ...
          <div className="mt-3 flex items-start gap-[9px] rounded-xl border border-[#BFE0EF] bg-teal-soft px-[14px] py-3 text-[12.5px] font-semibold leading-relaxed text-blue">
            <span aria-hidden>🧾</span>
            <div>
              Réservé par : <b>le cabinet</b> · canal <b>téléphone</b>. Cette information est
              tracée.
            </div>
          </div>
        </div>
